...
| 3                   | 011- 034 | 24      | DH   | Data e hora da gravação do registro.                                                                                                                                                       |
| 4                   | 035- 036 | 2       | N    | Tipo de evento: <br>"02": retorno de energia (REP-C ou REP-P); <br>"07": disponibilidade de serviço (somente para REP-P); <br>"08": indisponibilidade de serviço (somente para REP-P).<br> |
